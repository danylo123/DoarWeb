...
public class TelaPesquisaEstabelecimento extends javax.swing.JFrame {
    ...
    public TelaPesquisaEstabelecimento() {
        initComponents();
        atualizarTabela(dao.listarEstabelecimentos());

    }

    public void atualizarTabela(List<Estabelecimento> estabelecimentos) {
        EstabelecimentoTableModel tm = new EstabelecimentoTableModel(estabelecimentos);
